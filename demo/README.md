...
1. Renomeie o arquivo **./graph-tutorial/config.example.js** para **./Graph-tutorial/config.js**.
1. Edite o arquivo **./graph-tutorial/config.js** e faça as seguintes alterações.
...
1. Abra um navegador e navegue até `http://localhost:8080`.
